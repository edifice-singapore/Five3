...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="product-list">
    ...
    <div style="width:350px;padding:10px">
      ...
      ?>
      <div class="image"><a href="<?php echo $product['href']; ?>"><img style="border:none;" src="<?php echo $product['thumb']; ?>" title="<?php echo $product['name']; ?>" alt="<?php echo $product['name']; ?>" /></a></div>
      <?php } ?>
      <div class="name"><a href="<?php echo $product['href']; ?>"  style="color:black; font-family: "Josefin Sans",sans-serif;text-transform: uppercase;font-size:13pt;"><?php echo $product['name']; ?></a></div>
...
function display(view) {
	if (view == 'list') {
		...
		$('.product-grid > div').each(function(index, element) {
			...
			if (price != null) {
				html += '<div class="price" style="color:gray">' + price  + '</div>';
			}
