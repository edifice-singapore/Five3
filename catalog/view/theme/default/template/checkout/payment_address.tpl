...
<p>
  ...
  <label for="payment-address-new" style="font-family:calibri;color:#555555;font-weight:bold;font-size:11pt"><?php echo $text_address_new; ?></label>
</p>
<?php } ?>
...
<div id="payment-new" style="display: <?php echo ($addresses ? 'none' : 'block'); ?>;">
  <table class="form">
    ...
    <tr>
      <td class="textHead" class="textHead"><?php echo $entry_city; ?> <span class="required textHead">*</span> </td>
      <td><input type="text" name="city" value="" class="large-field" /></td>
    </tr>
    <tr>
      <td class="textHead"><?php echo $entry_postcode; ?> <span id="payment-postcode-required" class="required textHead">*</span> </td>
